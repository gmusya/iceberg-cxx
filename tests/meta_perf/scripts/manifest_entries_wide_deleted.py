...
spark.sql("""
    CREATE TABLE IF NOT EXISTS demo.performance.manifest_entries_wide_updated (
        id BIGINT,
        id0 BIGINT,
        id1 BIGINT,
        id2 BIGINT,
...
df.writeTo("demo.performance.manifest_entries_wide_updated") \
    .append()

spark.sql("UPDATE demo.performance.manifest_entries_wide_updated SET id0 = 42 WHERE id0 = 2101")
